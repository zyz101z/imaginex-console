...
export const VOICE_FILES = {
  ...
  holddoor: 'audio/pat_hold_the_door.wav', rkt: 'audio/pat_rkt.wav', wherego: 'audio/pat_where_did_he_go.wav', waitforme: 'audio/pat_wait_for_me.wav', foundyou: 'audio/pat_found_you.wav', replyall: 'audio/pat_reply_all.wav', bitcoin: 'audio/pat_bitcoin.wav', ow: 'audio/pat_ow.wav', niceshot: 'audio/pat_nice_shot.wav', missed: 'audio/pat_missed.wav', peekaboo: 'audio/pat_peekaboo.wav', showyou: 'audio/pat_show_you.wav', wasthatyou: 'audio/pat_was_that_you.wav', dontmove: 'audio/pat_dont_move.wav', gotcha: 'audio/pat_gotcha.wav', headsup: 'audio/pat_heads_up.wav', thinkfast: 'audio/pat_think_fast.wav', catch: 'audio/pat_catch.wav', hr: 'audio/pat_hr.wav', soclose: 'audio/pat_so_close.wav', fanup: 'audio/pat_fan_up.wav',
  // Intro cinematic: narrator (Voicebox Kokoro 'Onyx' preset — see GAME_DESIGN.md) + Pat's cut-off line
